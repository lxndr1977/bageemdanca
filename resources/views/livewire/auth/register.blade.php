...
new #[Layout('components.layouts.auth')] class extends Component {
    ...
    public function register(): void
    {
        ...
        $this->redirectIntended(route('site', absolute: false), navigate: true);
    }
}; ?>
    ...
    <div class="-mt-12">
        ...
        <form wire:submit="register" class="flex flex-col gap-3">
            ...
            <div class="flex items-center justify-end mt-2">
                <x-mary-button type="submit" class="w-full" style="background-color: var(--button-color) !important; color: var(--button-text-color); border: none;">
                    {{ __('Create account') }}
                </x-mary-button>
            </div>
        </form>
