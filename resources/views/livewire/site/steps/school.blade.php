<div>
   ...
   <x-mary-modal wire:model="showExplanationModal" title="Bem-vindo ao Formulário de Inscrição" separator>
      <div class="p-4 text-gray-700 space-y-4">
         <p><strong>Bem-vindo ao formulário de inscrição do {{ $systemConfig?->festival_name ?? 'Vem Dançar Sudamérica 2025' }}!</strong></p>
      ...
      <x-slot:actions>
         <x-mary-button label="Entendi" wire:click="closeExplanationModal" class="btn-primary" style="background-color: var(--button-color); color: var(--button-text-color); border: none;" />
      </x-slot:actions>
   </x-mary-modal>
