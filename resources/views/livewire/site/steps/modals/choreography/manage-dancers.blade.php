...
<x-mary-modal wire:model="manageDancersModal" title="Gerenciar Bailarino(as)" class="backdrop-blur"
   ...
   <x-slot:actions>
      ...
      <x-mary-button icon="o-check" wire:click="syncDancers" class="btn-primary" style="background-color: var(--button-color); color: var(--button-text-color); border: none;" spinner="syncDancers">
         Salvar Bailarino(as)
      </x-mary-button>
   </x-slot:actions>
</x-mary-modal>