...
<x-mary-modal wire:model="manageChoreographersModal" title="Gerenciar Coreógrafos(as)" class="backdrop-blur"
   ...
   <x-slot:actions>
      ...
      <x-mary-button icon="o-check" wire:click="syncChoreographers" class="btn-primary" style="background-color: var(--button-color); color: var(--button-text-color); border: none;"
