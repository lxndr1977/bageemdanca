...
<div>
   <div class="grid grid-cols-1 md:grid-cols-2 mb-2 md:mb-8">
      ...
      <div class="text-left md:text-right mb-6">
         <x-mary-button icon="o-plus" @click="$wire.choreographerModal = true" class="btn-primary" style="background-color: var(--button-color); color: var(--button-text-color); border: none;">
