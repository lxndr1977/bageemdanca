...
trait WithChoreographyStep
{
    ...
    protected function choreographyMessages(): array
{
    return [
        'choreographyState.name.required' => 'O nome da coreografia é obrigatório.',
        'choreographyState.name.string' => 'O nome da coreografia deve ser um texto válido.',
        'choreographyState.name.max' => 'O nome da coreografia não pode ter mais de 255 caracteres.',

        'choreographyState.choreography_type_id.required' => 'A formação é obrigatória.',
        'choreographyState.choreography_type_id.exists' => 'A formação selecionada é inválida.',

        'choreographyState.choreography_category_id.required' => 'A categoria é obrigatória.',
        'choreographyState.choreography_category_id.exists' => 'A categoria selecionada é inválida.',

        'choreographyState.dance_style_id.required' => 'O estilo de dança é obrigatório.',
        'choreographyState.dance_style_id.exists' => 'O estilo de dança selecionado é inválido.',

        'choreographyState.music.required' => 'O nome da música é obrigatório.',
        'choreographyState.music.string' => 'O nome da música deve ser um texto válido.',
        'choreographyState.music.max' => 'O nome da música não pode ter mais de 255 caracteres.',

        'choreographyState.music_composer.required' => 'O nome do compositor é obrigatório.',
        'choreographyState.music_composer.string' => 'O nome do compositor deve ser um texto válido.',
        'choreographyState.music_composer.max' => 'O nome do compositor não pode ter mais de 255 caracteres.',

        'choreographyState.duration.required' => 'A duração da coreografia é obrigatória.',
        'choreographyState.duration.string' => 'A duração deve ser um texto válido.',
        'choreographyState.duration.max' => 'A duração não pode ter mais de 8 caracteres.',
    ];
}
    ...
    {
        $this->validate($this->choreographyRules(), $this->choreographyMessages());
